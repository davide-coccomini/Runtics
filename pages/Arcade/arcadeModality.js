        ...
        <View style={styles.container}>
          ...
          <View style={styles.titleContent}>
            ...
            <View style={styles.titleContent}>
              ...
              <TouchableOpacity style={styles.buttonContainerHalf}  onPress={() =>{ navigate('ArcadeLevels'); tracker.trackScreenView("Arcade Levels"); this.props.actions.setting_modality(1); this.props.tutorialActions.making_tutorial()}}>
              ...
              <TouchableOpacity style={styles.buttonContainerHalf}  onPress={() =>{ navigate('ArcadeLevels'); tracker.trackScreenView("Arcade Levels"); this.props.actions.setting_modality(2); this.props.tutorialActions.making_tutorial()}}>
